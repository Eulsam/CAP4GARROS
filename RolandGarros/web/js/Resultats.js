...
tour = document.getElementById("tour1");
        tour.innerHTML = "<p id = 'tour1' ><strong>Tour 1</strong><p/><p id = 'tour1' ><strong>----------------------------------------</strong><p/>";
        for (var i = 1; i < 65; i++) {
tour.innerHTML= tour.innerHTML+ "<table class ="+i+"><thead> Match " +i+"<thead/><body><body/><tr><td><input id = nomA"+i+" name='nom1'   style = 'width:150px' placeholder='nom1' /></td><td><input id = 'scoreA'"+i+" name='score1'  style = 'width:50px' placeholder='score1' /></td></tr><tr><td><input id = 'nomB'"+i+" name='nom2'  style = 'width:150px' placeholder='nom2' /></td><td><input id = 'scoreB'"+i+" name='score2'  style = 'width:50px' placeholder='score2' /></td></tr></table>";
        }

tour = document.getElementById("tour2");
        tour.innerHTML = "<p id = 'tour2' ><strong>Tour 2</strong><p/><p id = 'tour2' ><strong>----------------------------------------</strong><p/>";
        for (var i = 65; i < 97; i++) {
tour.innerHTML= tour.innerHTML+ "<table class ="+i+"><thead> Match " +i+"<thead/><body><body/><tr><td><input id = nomA"+i+" name='nom1'   style = 'width:150px' placeholder='nom1' /></td><td><input id = 'scoreA'"+i+" name='score1'  style = 'width:50px' placeholder='score1' /></td></tr><tr><td><input id = 'nomB'"+i+" name='nom2'  style = 'width:150px' placeholder='nom2' /></td><td><input id = 'scoreB'"+i+" name='score2'  style = 'width:50px' placeholder='score2' /></td></tr></table>";
